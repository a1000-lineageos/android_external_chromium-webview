...
# A1000: форма "@" оставляет .so внутри apk. На Android 8.1 это не работает:
# PackageManagerService для bundled системного приложения строит
# nativeLibraryDir как <apkdir>/lib/<isa> и не умеет читать либу из apk, так
# что WebView падал с UnsatisfiedLinkError, а вместе с ним и браузер. Отдаём
# либы обычными файлами (распакованы в external/chromium-webview/lib/ скриптом
# firmware/fix_webview_jni.sh), чтобы build положил их в
# system/app/webview/lib/arm/.
